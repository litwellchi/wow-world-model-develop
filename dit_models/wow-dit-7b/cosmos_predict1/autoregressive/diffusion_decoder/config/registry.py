...
def register_tokenizer(cs):
    cs.store(
        ...
        node=get_cosmos_video_tokenizer_comp8x8x8(
            resolution="720",
            chunk_duration=121,
            checkpoint_path="/Data/pd/Code/cosmos/ckpts/Cosmos-5B-Video2World/Cosmos-Tokenize1-CV8x8x8-720p/.jit",
        ),
    )
...
def register_corruptor(cs):
    cs.store(
        ...
        node=get_cosmos_video_discrete_tokenizer_comp8x16x16(
            resolution="720",
            chunk_duration=49,
            checkpoint_path="/Data/pd/Code/cosmos/ckpts/Cosmos-5B-Video2World/Cosmos-Tokenize1-DV8x16x16-720p/.jit",
        ),
    )
