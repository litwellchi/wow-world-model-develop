...
class DatasetPD(Dataset):
    def __init__(
        ...
        self.video_paths = [x if x.startswith("/mnt/world_foundational_model") else x.replace("/mnt", "/mnt/world_foundational_model", 1) for x in self.video_paths]
