...
import importlib
import os
os.environ["WANDB_API_KEY"] = "ea7767591e96c76340197cb4b9399be44d0a0fec"
import wandb
...
from cosmos_predict1.utils.distributed import is_local_rank0, is_rank0
...
def launch(config: Config, args: argparse.Namespace) -> None:
    ...
    if (is_local_rank0() and is_rank0()) and not wandb.run:
        wandb.init(
            project="cosmos_predict1",
            name="sft-200k-longtext",
            reinit=False,
        )
